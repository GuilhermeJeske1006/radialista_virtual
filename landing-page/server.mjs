...
const types = { '.html': 'text/html; charset=utf-8', '.css': 'text/css; charset=utf-8', '.js': 'text/javascript; charset=utf-8', '.svg': 'image/svg+xml', '.woff2': 'font/woff2', '.webp': 'image/webp', '.png': 'image/png', '.jpg': 'image/jpeg', '.txt': 'text/plain; charset=utf-8', '.xml': 'application/xml; charset=utf-8', '.mp3': 'audio/mpeg', '.mp4': 'video/mp4', '.vtt': 'text/vtt; charset=utf-8', '.ico': 'image/x-icon', '.webmanifest': 'application/manifest+json' };
...
http.createServer(async (req, res) => {
  try {
    ...
    if (!['index.html', 'styles.css', 'script.js', 'theme.js', 'config.js', 'robots.txt', 'sitemap.xml', 'favicon.ico', 'favicon.svg', 'favicon-96x96.png', 'apple-touch-icon.png', 'site.webmanifest', 'web-app-manifest-192x192.png', 'web-app-manifest-512x512.png'].includes(relative) && !/^assets\/[a-zA-Z0-9_.-]+$/.test(relative)) { res.writeHead(404); res.end('Não encontrado'); return; }
