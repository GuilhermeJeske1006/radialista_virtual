  ...
  return (
    <AppShell title="Equipe" maxWidthClassName="max-w-3xl">
      <div className="space-y-5">
        ...
        <form onSubmit={convidar} className="bg-surface rounded-3xl border border-border-strong shadow-theme-xs p-6">
              ...
              >
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <select
                    ...
                    className="rounded-xl border border-border-strong bg-bg px-2.5 py-1.5 text-xs font-medium text-fg disabled:opacity-50"
                  >
                    <option value="membro">Membro</option>
                    <option value="admin">Admin</option>
                  </select>
                  <button
                    ...
                    className="rounded-xl border border-laranja/40 px-3 py-1.5 text-xs font-medium text-laranja hover:bg-laranja/10 disabled:opacity-40 disabled:cursor-not-allowed"
                  >
                    Remover
                  </button>
                </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <button
                      ...
                      className="rounded-xl border border-border-strong px-3 py-1.5 text-xs font-medium text-fg hover:bg-fg/5"
                    >
                      Reenviar
                    </button>
                    <button
