  ...
  return (
    <AppShell title="Dashboard" maxWidthClassName="max-w-4xl">
      ...
      {onboardingIncompleto && (
        <div className="flex items-start justify-between gap-4 rounded-2xl border border-roxo-claro/40 bg-roxo/10 px-5 py-4 mb-6">
          <div>
            ...
            <p className="text-sm text-fg/65 mt-0.5">
              ...
              <Link href="/billing" className="text-roxo-claro hover:text-roxo-dim font-medium">
                Finalizar assinatura
              </Link>
              {" "}· revise também{" "}
              <Link href="/configuracoes" className="text-roxo-claro hover:text-roxo-dim font-medium">
                Configurações
              </Link>
              {" "}e{" "}
              <Link href="/radialista" className="text-roxo-claro hover:text-roxo-dim font-medium">
                Radialistas
              </Link>
              .
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-5">
              ...
              <p className="flex items-center gap-2 font-display text-2xl font-bold text-fg">
                <LocufyLed color={whatsappConectado ? "ciano" : "roxo"} pulse={false} />
            ...
            <div className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-5">
              ...
              {realmenteNoAr ? (
                ...
                <p className="flex items-center gap-2 font-display text-2xl font-bold text-fg/65">
                  <LocufyLed color="roxo" pulse={false} /> Ninguém
                </p>
              )}
            </div>
            <div className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-5">
            ...
            <Link
              href="/metrics"
              className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-5 hover:border-roxo-claro/40 transition-colors"
            >
          ...
          {mensagensPorDia.some((ponto) => ponto.total > 0) && (
            <div className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-5 mb-6">
              <div className="flex items-center justify-between mb-3">
                ...
                <Link href="/metrics" className="text-xs font-medium text-roxo-claro hover:text-roxo-dim">
                  Ver detalhes
                </Link>
              </div>
                ...
                <li key={t.label}>
                  <Link href={t.href} className="flex items-start gap-3 group">
                    ...
                    <span className="flex-1">
                      <span
                        className={`text-sm font-medium group-hover:text-roxo-claro transition-colors ${
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {ATALHOS.map((a) => (
                ...
                >
                  ...
                  <span className="text-roxo-claro shrink-0">→</span>
                </Link>
              ))}
            </div>
          </div>
