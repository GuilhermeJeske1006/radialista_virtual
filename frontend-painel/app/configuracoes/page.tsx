      ...
      <form onSubmit={salvar} className="bg-surface rounded-2xl border border-border-strong shadow-theme-xs p-6">
        ...
        <div>
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-border-strong bg-bg px-3 py-2 text-sm text-fg focus:outline-none focus:border-roxo-claro/50 focus:ring-2 focus:ring-roxo-claro/20 mb-4"
          />
        </div>
        <TagInput
        ...
        <button
          type="submit"
          disabled={salvando}
          className="mt-5 rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-on-brand hover:bg-brand-600 disabled:opacity-60 disabled:cursor-not-allowed"
        >
