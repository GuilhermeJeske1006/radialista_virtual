...
export function GraficoBarras({
  ...
  return (
    <div className="relative">
      {hover && (
        <div className="absolute -top-1 left-1/2 -translate-x-1/2 -translate-y-full rounded-xl bg-grafite px-2.5 py-1.5 text-xs text-branco shadow-theme-sm whitespace-nowrap pointer-events-none z-10">
